...
public class OceanTester {
	...
	public static TestResult[] testBoatInitial(Ocean o) throws Exception {
		...
		*/
		results[0] = new TestResult(true, "REMOVED", "REMOVED", "REMOVED");
